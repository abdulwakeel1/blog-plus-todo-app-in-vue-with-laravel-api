                            ...
                            <div class="list-wrapper">
                                <ul class="d-flex flex-column-reverse todo-list">
                                    <li>
                                        ...
                                        <i class="remove "><b>X</b></i>
                                    </li>
                                    <li>
                                        <div class="form-check"> 
                                            <label class=""> 
                                                <input class="checkbox" type="checkbox"> For what reason would it be advisable for me to think. 
                                                <i class="input-helper"></i>
                                            </label> 
                                        </div> 
                                        <i class="remove "><b>X</b></i>
                                    ...
                                    <li>
                                        <div class="form-check"> 
                                            <label class=""> 
                                                <input class="checkbox" type="checkbox"> it be advisable for me to think about business content? 
                                                <i class="input-helper"></i>
                                            </label> 
                                        </div> 
                                        <i class="remove "><b>X</b></i>
                                    ...
                                    <li>
                                        <div class="form-check"> 
                                            <label class=""> 
                                                <input class="checkbox" type="checkbox"> Print Statements all 
                                                <i class="input-helper"></i>
                                            </label> 
                                        </div> 
                                        <i class="remove "><b>X</b></i>
                                    ...
                                    <li>
                                        <div class="form-check"> 
                                            <label class=""> 
                                                <input class="checkbox" type="checkbox"  > Call Rampbo 
                                                <i class="input-helper"></i>
                                            </label> 
                                        </div> 
                                        <i class="remove "><b>X</b></i>
...
<style>
    ...
    @media 
    (max-width:991.98px){.padding{padding: 1.5rem}}
    ...
    }.pr-3, .px-3{padding-right: 1rem !important}.card .card-body{padding: 1.25rem 1.75rem}.card-body{flex: 1 1 auto;padding: 1.25rem}.card .card-title{color: #000000;margin-bottom: 0.625rem;text-transform: capitalize;font-size: 0.875rem;font-weight: 500}.add-items{margin-bottom: 1.5rem;overflow: hidden}.d-flex{display: flex !important}
    .add-items input[type="text"]
    {
        ...
        .form-check .form-check-label input
        {
            ...
            opacity: 0;
            filter: alpha(opacity=0)}input[type="radio"], 
            input[type="checkbox"]
            {
